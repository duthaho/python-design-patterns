...
class SQLQuery:
    ...
    table: str = ""
    where: tuple[tuple[str, ...]] = field(default_factory=tuple)  # (condition, param1, param2, ...)
    join: str = ""
    order_by: str = ""
    limit: int | None = None
...
class SQLQueryDirector:
    ...
    def user_orders_report(self, user_table: str, orders_table: str, min_total: float) -> SQLQuery:
        return (self._builder.reset()
